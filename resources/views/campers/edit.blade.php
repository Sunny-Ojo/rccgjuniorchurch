            ...
            <div class="col-md-7 col-xs-12">
             ...
             <div class="card my-5">
                 <div class="card-header">
                    <h4 class="lead text-center ">Update {{ $campers->surname }} {{ $campers->firstName."'s" }} Profile</h4>
                    ...
                    <div class="card-body">
                      ...
                      {!! Form::open(['action' => ['AdminController@update',$campers->id], 'method' => 'PUT', 'enctype'=> 'multipart/form-data']) !!}
                      <div class="form-group">
                        {{ Form::label('surname', 'Enter your Surname') }}
                        {{ Form::text('surname', $campers->surname, ['class'=>'form-control', 'placeholder'=>' Surname']) }}
                      </div>
                      <div class="form-group">
                        {{ Form::label('firstName', 'Enter your first name') }}
                        {{ Form::text('firstName', $campers->firstName, ['class'=>'form-control', 'placeholder'=>'First Name']) }}
                      </div>
                      <div class="form-group">
                        {{ Form::label('parentsName', 'Enter your parents name') }}
                        {{ Form::text('parentsName', $campers->nameOfParents, ['class'=>'form-control', 'placeholder'=>'Parents Name']) }}
                      </div>
                      <div class="form-group">
                        {{ Form::label('parentsPhone', 'Enter your Parents phone number') }}
                        {{ Form::text('parentsPhone', $campers->parentContact, ['class'=>'form-control', 'placeholder'=>'Parents phone number']) }}
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        {{ Form::date('dob', $campers->dob, ['class'=>'form-control']) }}
                      </div>
                           <div class="form-group">
                        {{ Form::label('gender', 'Select your Gender: ') }}
                      {{ Form::select('gender', ['Female' => 'female', 'Male' => 'male' ], $campers->gender,['class'=>'form-control'])  }}
                      </div>
                       <div class="form-group">
                        ...
                        ],$campers->zone,['class'=>'form-control'])  }}
                      </div>
                      ...
                      'Flourishing'=>'Area 35 - Flourishing','Holiness Assembly'=>'Area 36 - Holiness Assembly',' Hope of Glory'=>'Area 37 - Hope of Glory','Restoration'=>'Area 38 - Restoration' ],$campers->area,['class'=>'form-control'])  }}
                      </div>
                      <div class="form-group">
                        {{ Form::label('parish', 'Enter  your Parish name: ') }}
                      {{ Form::text('parish',$campers->parish,['class'=>'form-control'])  }}
                      </div>
               ...
               {{ Form::file('passport') }}
                <br>
                 <img style="height:120px;width:140px" src="{{'/storage/passports/'.$campers->passport }}" alt="Passport">
         </div>
                      <div class="form-group">
                        {{ Form::label('allergies', 'Any Allergies?') }}
                        {{ Form::textarea('allergies', $campers->allergies, ['class'=>'form-control', 'placeholder'=>'Allergies? Tell us']) }}
                      </div>
                      <div>
