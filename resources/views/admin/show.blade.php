...
@section('title', 'View Profile')
    ...
    <a href="/admin"class="btn btn-secondary mb-2">Previous page</a>
              ...
              <div class="row">
                ...
                <h4><strong>Parents Name:</strong> {{ $users->nameOfParents }}</h4>
                ...
                <h4><strong>Zone:</strong> {{ $users->zone }}</h4>
                <h4><strong>Area:</strong> {{ $users->area }}</h4>
                <h4><strong>Allergies:</strong> {{ $users->allergies }}</h4>
                {{-- <h4><strong>Parent/Guardian Info:</strong> {{ $users->guardiandetails }}</h4> --}}
                </div>
                           </div>
                <br>
